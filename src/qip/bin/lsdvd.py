...
def main():
    ...
    pgroup = app.parser.add_argument_group('Device')
    ...
    xgroup = pgroup.add_mutually_exclusive_group()
    xgroup.add_argument('--format', default='human', choices=('human', 'perl', 'python', 'ruby', 'xml', 'json'), help='output format')
    xgroup.add_argument('-Oh', dest='format', default=argparse.SUPPRESS, action='store_const', const='human', help='output as human readable')
    xgroup.add_argument('-Op', dest='format', default=argparse.SUPPRESS, action='store_const', const='perl', help='output as human Perl')
    xgroup.add_argument('-Oy', dest='format', default=argparse.SUPPRESS, action='store_const', const='python', help='output as Python')
    xgroup.add_argument('-Or', dest='format', default=argparse.SUPPRESS, action='store_const', const='ruby', help='output as Ruby')
    xgroup.add_argument('-Ox', dest='format', default=argparse.SUPPRESS, action='store_const', const='xml', help='output as XML')
    xgroup.add_argument('-Oj', dest='format', default=argparse.SUPPRESS, action='store_const', const='json', help='output as JSON')
